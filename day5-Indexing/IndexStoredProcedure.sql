-- View : Forward only, record only record sets
-- Searching should be done with all indexed columns for better performance.

-- Creating Index : 1. Create a temp table, 2. Create index on that temp table
